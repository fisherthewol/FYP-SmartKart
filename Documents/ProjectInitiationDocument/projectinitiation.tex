...
\begin{center}
    ...
    Word Count: 2058 %exclude acknowledgements, abstract, table of contents, references and appendices) of your document.
\end{center}
\newpage
...
\begin{landscape}
    \begin{figure}[h]
        \makebox[\textwidth][c]{\includegraphics[width=1.3\paperwidth]{GanttChart.png}}
        \centering
...
\begin{figure}[h]
    \makebox[\textwidth][c]{\includegraphics[width=0.7\paperwidth]{KanbanBoardMerged}}
    \centering
