...
class AverageSpeedModelFactory(private val locMan: LocationManager, private val speedLimit: MutableLiveData<Int> = MutableLiveData(0)): ViewModelProvider.Factory {
